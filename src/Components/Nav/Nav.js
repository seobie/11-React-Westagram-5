      ...
      <nav className="Nav">
        <div className="navContainer">
          ...
          <div className="navSearch">
            ...
            <div className="searchIcon" role="button">
              <div>
                <span className="magImg"></span>
                <span>Search</span>
              </div>
            </div>
          </div>
          <div className="navBtnContainer">
            <div className="navBtns">
              ...
              <div className="navDirect navBtn">
                <svg
                  aria-label="Direct"
                  fill="#262626"
                  height="22"
              ...
              <div className="navExplore navBtn">
                <svg
              ...
              <div className="navActivities navBtn">
                <svg
              ...
              <div className="navProfile navBtn">
                <img
