          ...
          <div className="feedsStoryBox">
            <ul className="feedsStoryList">
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/IMG_5186.JPG"
                    alt="mommy's profile pic"
                  />
                </a>
                <a href="/">
              ...
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/weocde.jpeg"
                    alt="wecode's profile pic"
                  />
                </a>
                <a href="/">
              ...
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/kim.jpg"
                    alt="glory_K's profile pic"
                  />
                </a>
                <a href="/">
              ...
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/IMG_3607.JPG"
                    alt="jjo_nii_'s profile pic"
                  />
                </a>
                <a href="/">
                  <div className="feedsStoryListId">jjo_nii_</div>
                </a>
              </li>
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/king.jpg"
                    alt="camellia's profile pic"
                  />
                </a>
                <a href="/">
              ...
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/jenny.jpg"
                    alt="jenny.blackk's profile pic"
                  />
                </a>
                <a href="/">
              ...
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/gd.jpg"
                    alt="g-dragon's profile pic"
                  />
                </a>
                <a href="/">
              ...
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/dua.jpg"
                    alt="dua_lipa_'s profile pic"
                  />
                </a>
                <a href="/">
              ...
              <li className="feedsStoryListIdBox">
                <a href="/">
                  <img
                    src="images/joeunlee/wook.png"
                    alt="actor_wook's profile pic"
                  />
                </a>
                <a href="/">
            ...
            <div className="replySection">
              ...
              <section className="replyListBox">
                ...
                <div className="replyNumber">
                  <a href="/">
                    댓글 <span>8</span>개 모두 보기
                  </a>
                </div>
                <ul>
                  {this.state.newArr.map((el, idx) => {
                    return <Reply reply={el} key={idx} />;
                  })}
                </ul>
              </section>
              ...
              <section className="replyTypeBox">
                <form className="replyTypeLine">
                  ...
                  <button
                    className={`replyBtn${
                      this.state.txtVal ? "Active" : "Disabled"
                    }`}
            ...
            <div className="recommendListBox">
              <div className="recommendList">
                <div className="recommendListRight">
                  <img
                    src="images/joeunlee/ha.jpg"
                    alt="jeongwoo_haha's profile pic"
                  />
              ...
              <div className="recommendList">
                <div className="recommendListRight">
                  <img
                    src="images/joeunlee/yun.jpg"
                    alt="god_yun's profile pic"
                  />
                  <div className="recommendListName">
                    <a href="/">god_yun</a>
                    <div className="recommendListInfo">회원님을 위한 추천</div>
              ...
              <div className="recommendList">
                <div className="recommendListRight">
                  <img
                    src="images/joeunlee/zico.jpg"
                    alt="zzzzzziaco's profile pic"
                  />
                  <div className="recommendListName">
                    <a href="/">zzzzzziaco</a>
                    <div className="recommendListInfo">회원님을 위한 추천</div>
              ...
              <div className="recommendList">
                <div className="recommendListRight">
                  <img
                    src="images/joeunlee/park.jpg"
                    alt="seojun.park's profile pic"
                  />
                  <div className="recommendListName">
