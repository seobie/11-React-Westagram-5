...
class Feed extends Component {
    ...
    addComment = () => {
        this.setState({ lists: this.state.lists.concat(this.state.id + ' ' + this.state.message) });
                ...
                <section>
                    <div className="feedContainer">
                        ...
                        <div className="commentLine">
                            <img className="icon_heart" alt="하트아이콘"
                                src="https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/bearu/heart.png" />
                            <img className="icon_commit" alt="말풍선아이콘"
                                src="https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/bearu/comment.png" />
                            <img className="icon_share" alt="공유아이콘"
                                src="https://s3.ap-northeast-2.amazonaws.com/cdn.wecode.co.kr/bearu/share.png" />
                            <img className="iconBookMark" alt="북마크아이콘"
                            ...
                            <div className="commentsBox">
                                <textarea onKeyDown={this.handleKeyPress} onChange={this.onChangeInput} value={this.state.message} className="inputComment" type="text" placeholder="댓글달기..."></textarea>
                                <button className={(this.state.message ? "submitButton" : "submitButton1")}
